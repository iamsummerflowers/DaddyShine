...
function Order({config=defaultConfig}) {
  ...
  return (
        <section id="order" className="relative py-24 bg-[#1F1F1F]">
          {/* Background Pattern */}
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center mb-16">
              <span className="w-fit inline-block px-4 py-1 bg-[#DAA520]/20 text-[#DAA520] rounded-full text-sm font-semibold mb-4">
                Order Now
              </span>
              <h2 
              ...
              >
                Choose Your <span className="text-[#DAA520]">Flavor</span>
              </h2>
              ...
              {products.map((product, index) => (
                <div
                  ...
                  className={`relative p-6 rounded-2xl transition-all hover:-translate-y-2 ${
                    product.popular 
                      ? 'bg-gradient-to-br from-[#DAA520]/20 to-[#DAA520]/5 border-2 border-[#DAA520]' 
                      : 'bg-black/50 border border-white/10 hover:border-[#DAA520]/50'
                  }`}
                >
                  {product.popular && (
                    <span className="w-fit absolute -top-3 left-1/2 -translate-x-1/2 px-3 py-1 bg-[#DAA520] text-black text-xs font-bold rounded-full">
                      POPULAR
                    </span>
                  )}
                  <img 
                  ...
                  <div className="font-poppins font-bold text-2xl text-[#DAA520]">{product.price}</div>
                </div>
              ))}
            </div>
            ...
            <div className="max-w-2xl mx-auto">
              <div className="bg-black/50 border-2 border-[#DAA520] rounded-3xl p-8 text-center">
                <div className="w-16 h-16 bg-[#DAA520]/20 rounded-full flex items-center justify-center mx-auto mb-6">
                ...
                <div className="bg-[#DAA520]/10 rounded-xl p-4 mb-6">
                  <p className="text-sm text-[#DAA520] mb-2">Send payment to:</p>
                ...
                <div className="text-left space-y-3 text-white/70">
                  <p className="flex items-start gap-3">
                    <span className="w-6 h-6 bg-[#DAA520]/20 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                      <span className="w-fit text-gold text-sm font-bold">1</span>
                    </span>
                    Select your favorite flavors and note the total
                  </p>
                  <p className="flex items-start gap-3">
                    <span className="w-6 h-6 bg-[#DAA520]/20 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                      <span className="w-fit text-gold text-sm font-bold">2</span>
                    </span>
                    Send payment via Zelle with your order details in the memo
                  </p>
                  <p className="flex items-start gap-3">
                    <span className="w-6 h-6 bg-[#DAA520]/20 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                      <span className="w-fit text-gold text-sm font-bold">3</span>
                    </span>
                    Include your name, address, and contact info
                  </p>
                  <p className="flex items-start gap-3">
                    <span className="w-6 h-6 bg-[#DAA520]/20 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                      <span className="w-fit text-gold text-sm font-bold">4</span>
                    </span>
